 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      let count = this.get(rowIndex).reduce((acc, curr) => acc + curr, 0);
      return count > 1;
    },
    ...
    hasAnyRowConflicts: function() {
      ...
      for (let i = 0; i < this.attributes.n; i++) {
        resultSoFar = resultSoFar || this.hasRowConflictAt(i);
      }
      return resultSoFar;
    },
    ...
    hasAnyColConflicts: function() {
      ...
      let resultSoFar = false;
      for (let i = 0; i < boardLength; i++) {
        resultSoFar = resultSoFar || this.hasColConflictAt(i);
      }
      return resultSoFar;
    },
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      let boardLength = this.attributes.n;
      let diagonal = majorDiagonalColumnIndexAtFirstRow;
      let count = 0;

      if (Math.abs(diagonal) === boardLength - 1) {
        return false;
      }
    ...
    hasAnyMajorDiagonalConflicts: function() {
      let boardLength = this.attributes.n;
      let resultSoFar = false;
      for (let i = -boardLength + 1; i < boardLength; i++) {
        resultSoFar = resultSoFar || this.hasMajorDiagonalConflictAt(i);
      }
      return resultSoFar;
    },
